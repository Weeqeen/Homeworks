# -*- coding: utf-8 -*-
"""Копия Практика 0.7.0.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1in4eQJ7NNSZsYPpeqTwpbCJPcTkf3NkQ
...
def list_posts(data):
    ...
    for i in range(len(data)):
      list1.append(data[i]["title"])
    return list1


def clear_data(data, id):
    for i in range(10):
      if data[i]["id"] == id:
        return data[i]


def clear_important_info(data, id):
    title = clear_data(data, id)["title"]
    body = clear_data(data, id)["body"]
    return f"Название поста: {title}, Тело поста: {body}"


id = int(input("Введите 'id' поста: "))
url = "https://jsonplaceholder.typicode.com/posts"
data = send_request(url)
#1 print(list_posts(data))
#2 print(clear_data(data, id))
#3 print(clear_important_info(data, id))
