...
# 6 - Выход
# Ваш запрос: 1
# Введите какая начальная сумма будет у вашего счёта(только число): 1000
# Счет создан с начальным балансом: 1000
# Введите номер действия, которое хотите выполнить:
# 1 - Создать счёт;
# 2 - Внести или снять деньги со счёта;
# 3 - Проверка баланса;
...
# 6 - Выход
# Ваш запрос: 1
# Введите какая начальная сумма будет у вашего счёта(только число): 500
# Счет создан с начальным балансом: 500
# Введите номер действия, которое хотите выполнить:
# 1 - Создать счёт;
# 2 - Внести или снять деньги со счёта;
# 3 - Проверка баланса;
...
# 6 - Выход
# Ваш запрос: 2
# Введите действие, которое хотите совершить со своим счётом(внести или снять деньги)
# Напишите '+', если хотите внести
# или '-', если хотите снять деньги.
# Ваш выбор: +
# Какой индекс у счёта, на который хотите положить деньги
# (если счёт создан первым, то индекс 0;
# если вторым, то индекс 1, и т.д.)
# Ваш индекс:1
# Введите сумму, которую хотите внести на ваш счёт: 750
# Вы внесли сумму, равную: 750. Текущий баланс: 1250
# Введите номер действия, которое хотите выполнить:
# 1 - Создать счёт;
# 2 - Внести или снять деньги со счёта;
# 3 - Проверка баланса;
...
# или '-', если хотите снять деньги.
# Ваш выбор: -
# Какой индекс у счёта, с которого хотите снять деньги
# (если счёт создан первым, то индекс 0;
# если вторым, то индекс 1, и т.д.)
# Ваш индекс:0
# Введите сумму, которую хотите снять с вашего счёта: 900
# Вы сняли сумму, равную: 900. Текущий баланс: 100
# Введите номер действия, которое хотите выполнить:
# 1 - Создать счёт;
# 2 - Внести или снять деньги со счёта;
# 3 - Проверка баланса;
...
# 6 - Выход
# Ваш запрос: 3
# Какой индекс у счёта, у которого хотите посмотреть баланс
# (если счёт создан первым, то индекс 0;
# если вторым, то индекс 1, и т.д.)
# Ваш индекс:0
# Текущий баланс: 100
...
# 6 - Выход
# Ваш запрос: 4
# Какой индекс у счёта, у которого хотите посмотреть трансзакции
# (если счёт создан первым, то индекс 0;
# если вторым, то индекс 1, и т.д.)
# Ваш индекс:0
# История транзакций для счета 0:
# Сняли: 900
# Введите номер действия, которое хотите выполнить:
# 1 - Создать счёт;
# 2 - Внести или снять деньги со счёта;
...
# 6 - Выход
# Ваш запрос: 5
# Какой индекс у счёта, с которого хотите перевести деньги
# (если счёт создан первым, то индекс 0;
# если вторым, то индекс 1, и т.д.)
# Ваш индекс:1
# Какой индекс у счёта, на который хотите перевести деньги
# (если счёт создан первым, то индекс 0;
# если вторым, то индекс 1, и т.д.)
# Ваш индекс:0
# Введите сумму, которую хотите перевести с счёта 1 на счёт 0: 600
# Переведено: 600 с счета 1 на счет 0.
# Введите номер действия, которое хотите выполнить:
# 1 - Создать счёт;
# 2 - Внести или снять деньги со счёта;
# 3 - Проверка баланса;
